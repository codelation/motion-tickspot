class TickProjectStub
  ...
  def call(request)
    ...
    if request.URL.absoluteString.start_with? "https://www.tickspot.com/api/v2/roles"
      ...
      sleep 0.1
    elsif request.URL.absoluteString.start_with? "https://www.tickspot.com/15/api/v2/projects"
      data = File.open("#{NSBundle.mainBundle.resourcePath}/projects.json").read.to_data
      sleep 0.1
    else
